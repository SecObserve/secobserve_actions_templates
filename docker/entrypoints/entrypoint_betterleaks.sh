...
export SO_PARSER_NAME="Betterleaks"
...
cd "$RUN_DIRECTORY"
betterleaks dir $FURTHER_PARAMETERS --no-banner --log-level warn --exit-code 0 --redact --report-format json --report-path "$WORKSPACE/$REPORT_NAME"
cd "$WORKSPACE"
